...
HOW TO PLAY:
 ...
 2.The game will start and the initial chess board with all coins placed at their respective intial position will be shown.
 ...
 4.Once the coin is selected,Now the available moves for that particular coin will be provided.The player can choose any move.
 5.Once it is done and it is valid then coin will be moved to that position entered by the user and the turn will be shifted to player2.
...
Recording:
  ...
  For each game all the steps will be noted in a seperate file named as "Steps_record".Both players moves will be noted down,which can be referred for later use.
